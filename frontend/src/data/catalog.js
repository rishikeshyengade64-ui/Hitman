export const ALL_CATEGORIES = [
  ...
  },
  {
    ...
    icon: 'pedal_bike',
    itemCount: 3,
    accurateItems: 'Carbon Road Bikes, Aero Helmets & Kits',
    image: 'https://images.unsplash.com/photo-1485965120184-e220f721d03e?auto=format&fit=crop&w=600&q=80',
    highlightBadge: 'Aero Velocity',
  },
];
...
export const ALL_PRODUCTS = [
  ...
  {
    id: 12,
    title: 'Apex Pro Shield High-Density Cricket Batting Pads',
    slug: 'apex-pro-shield-cricket-batting-pads',
    sku: 'SZ-CR-99301',
    description:
    ...
    reviewCount: 47,
    weightGrams: 890,
    midsoleTech: 'Gel Knee Cup Shield',
    propulsionUnit: 'High-Density Cane Stems',
    dropHeightMm: 0,
    primaryImageUrl:
    ...
    images: [
      {
        ...
        imageUrl:
          'https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?auto=format&fit=crop&w=800&q=80',
        angleLabel: 'Front Armour Profile',
      },
    ],
    variants: [
      { id: 1201, size: 'Adult / Men', color: 'Optic White / Volt', stockQuantity: 30 },
      { id: 1202, size: 'Youth', color: 'Optic White / Volt', stockQuantity: 15 },
    ],
  },
  {
    id: 13,
    title: 'Apex Striker Carbon Pro Firm Ground Football Boots',
    slug: 'apex-striker-carbon-pro-football-boots',
    sku: 'SZ-FB-55101',
    description:
    ...
    reviewCount: 88,
    weightGrams: 185,
    midsoleTech: 'Carbon Flex-Plate',
    propulsionUnit: 'SpeedStud FG Array',
    dropHeightMm: 4.0,
    primaryImageUrl:
    ...
    images: [
      {
        ...
        imageUrl:
          'https://images.unsplash.com/photo-1511886929837-354d827aae26?auto=format&fit=crop&w=800&q=80',
        angleLabel: 'Lateral Cleat Profile',
      },
    ],
    variants: [
      { id: 1301, size: '7', color: 'Solar Volt / Obsidian', stockQuantity: 18 },
      { id: 1302, size: '8', color: 'Solar Volt / Obsidian', stockQuantity: 24 },
      { id: 1303, size: '9', color: 'Solar Volt / Obsidian', stockQuantity: 30 },
      { id: 1304, size: '10', color: 'Solar Volt / Obsidian', stockQuantity: 20 },
    ],
  },
  {
    id: 14,
    title: 'AeroStride HydroVent Lightweight Marathon Race Singlet',
    slug: 'aerostride-hydrovent-marathon-race-singlet',
    sku: 'SZ-RN-88305',
    description:
    ...
    reviewCount: 63,
    weightGrams: 68,
    midsoleTech: 'HydroVent Micro-Mesh',
    propulsionUnit: 'Ultralight Aerodynamic Knit',
    dropHeightMm: 0,
    primaryImageUrl:
    ...
    images: [
      {
        ...
        imageUrl:
          'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?auto=format&fit=crop&w=800&q=80',
        angleLabel: 'Front Athletic Fit',
      },
    ],
    variants: [
      { id: 1401, size: 'S', color: 'Hyper Volt / Reflective', stockQuantity: 25 },
      { id: 1402, size: 'M', color: 'Hyper Volt / Reflective', stockQuantity: 40 },
      { id: 1403, size: 'L', color: 'Hyper Volt / Reflective', stockQuantity: 35 },
      { id: 1404, size: 'XL', color: 'Hyper Volt / Reflective', stockQuantity: 20 },
    ],
  },
  {
    id: 15,
    title: 'Apex HeavyDuty Neoprene Weightlifting Wrist Wraps & Straps',
    slug: 'apex-heavyduty-lifting-wraps-straps',
    sku: 'SZ-AP-11005',
    description:
    ...
    reviewCount: 134,
    weightGrams: 120,
    midsoleTech: '5mm Neoprene Support Core',
    propulsionUnit: 'Reinforced Webbing Weave',
    dropHeightMm: 0,
    primaryImageUrl:
    ...
    images: [
      {
        ...
        imageUrl:
          'https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?auto=format&fit=crop&w=800&q=80',
        angleLabel: 'Lifting Wrap Setup',
      },
    ],
    variants: [
      { id: 1501, size: 'Standard (One Size)', color: 'Stealth Black / Volt', stockQuantity: 75 },
    ],
  },
  {
    id: 16,
    title: 'Apex AeroSpeed Carbon Road Cycling Helmet',
    slug: 'apex-aerospeed-carbon-road-cycling-helmet',
    sku: 'SZ-CY-66101',
    description:
    ...
    reviewCount: 52,
    weightGrams: 240,
    midsoleTech: 'EPS In-Mold + MIPS Cage',
    propulsionUnit: 'Carbon Aero Ribs',
    dropHeightMm: 0,
    primaryImageUrl:
    ...
    images: [
      {
        ...
        imageUrl:
          'https://images.unsplash.com/photo-1559348349-86f1f65817fe?auto=format&fit=crop&w=800&q=80',
        angleLabel: 'Aero Lateral View',
      },
    ],
    variants: [
      { id: 1601, size: 'M (55-59cm)', color: 'Matte Obsidian / Volt', stockQuantity: 22 },
      { id: 1602, size: 'L (59-63cm)', color: 'Matte Obsidian / Volt', stockQuantity: 18 },
    ],
  },
  {
    id: 18,
    title: 'Apex Velocita Pro Carbon Disc Road Racing Bicycle',
    slug: 'apex-velocita-pro-carbon-road-bicycle',
    sku: 'SZ-CY-66001',
    description:
    ...
    reviewCount: 39,
    weightGrams: 7850,
    midsoleTech: 'Toray T800 Monocoque Carbon',
    propulsionUnit: 'Shimano 24-Speed Electronic Di2',
    dropHeightMm: 0,
    primaryImageUrl:
    ...
    images: [
      {
        ...
        imageUrl:
          'https://images.unsplash.com/photo-1485965120184-e220f721d03e?auto=format&fit=crop&w=800&q=80',
        angleLabel: 'Full Bike Profile',
      },
      {
        id: 1802,
        imageUrl:
          'https://images.unsplash.com/photo-1532298229144-0ec0c57515c7?auto=format&fit=crop&w=800&q=80',
        angleLabel: 'Carbon Cockpit & Frame',
      },
    ],
    variants: [
      { id: 1801, size: '52cm (S: 165-175cm)', color: 'Stealth Matte Obsidian / Volt', stockQuantity: 8 },
      { id: 1802, size: '54cm (M: 172-182cm)', color: 'Stealth Matte Obsidian / Volt', stockQuantity: 12 },
      { id: 1803, size: '56cm (L: 180-190cm)', color: 'Stealth Matte Obsidian / Volt', stockQuantity: 6 },
    ],
  },
  {
    id: 19,
    title: 'Apex AeroVent Wind-Tunnel Pro Cycling Jersey & Bib Set',
    slug: 'apex-aerovent-cycling-jersey-bib-set',
    sku: 'SZ-CY-66304',
    description:
    ...
    reviewCount: 65,
    weightGrams: 280,
    midsoleTech: 'Italian SpeedMesh Fabric',
    propulsionUnit: '4D Ergonomic Chamois Pad',
    dropHeightMm: 0,
    primaryImageUrl:
    ...
    images: [
      {
        ...
        imageUrl:
          'https://images.unsplash.com/photo-1576435728678-68d0fbf94e91?auto=format&fit=crop&w=800&q=80',
        angleLabel: 'Front Pro Fit',
      },
    ],
    variants: [
      { id: 1901, size: 'S', color: 'Volt Yellow / Stealth Obsidian', stockQuantity: 20 },
      { id: 1902, size: 'M', color: 'Volt Yellow / Stealth Obsidian', stockQuantity: 35 },
      { id: 1903, size: 'L', color: 'Volt Yellow / Stealth Obsidian', stockQuantity: 28 },
      { id: 1904, size: 'XL', color: 'Volt Yellow / Stealth Obsidian', stockQuantity: 15 },
    ],
  },
];
