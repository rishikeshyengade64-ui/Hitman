...
3. Configure the settings:
   ...
   - **Root Directory**: `backend` (if repo root is `sportzone`) or `sportzone/backend` (if repo root is Hitman)
...
3. Configure the settings:
   ...
   - **Root Directory**: `frontend` (if repo root is `sportzone`) or `sportzone/frontend` (if repo root is Hitman)
